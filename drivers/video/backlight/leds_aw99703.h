...
#define AW99703_BSTCTR1_OVPSEL_17P5V		(0 << 2)
...
#define AW99703_FLASH_FL_S_MASK			((15 << 0))
...
struct aw99703_data {
	...
	unsigned int auto_freq_high;
	unsigned int auto_freq_low;
